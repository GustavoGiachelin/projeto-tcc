...
class PointerLockControlsCannon extends THREE.EventDispatcher {
  constructor(camera, cannonBody) {
    ...
    this.velocityFactor = 0.0013
    this.jumpVelocity = 20

    this.pitchObject = new THREE.Object3D()
    // this.pitchObject.scale.set(0.1,0.1,0.1)
    this.pitchObject.add(camera)
    
    this.yawObject = new THREE.Object3D()
    this.yawObject.position.y = 2
    this.yawObject.scale.set(0.1,0.1,0.1)
  ...
  onMouseMove = (event) => {
    ...
    this.yawObject.rotation.y -= movementX * 0.0007
    this.pitchObject.rotation.x -= movementY * 0.0007
